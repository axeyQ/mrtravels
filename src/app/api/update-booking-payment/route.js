// Update your update-booking-payment API with rate limiting

// app/api/update-booking-payment/route.js
...
export async function POST(request) {
  try {
    ...
    return NextResponse.json({ error: error.message || 'Failed to update booking payment status' }, { status: 500 });
  }
}