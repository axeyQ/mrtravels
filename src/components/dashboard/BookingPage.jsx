...
import { Calendar, Clock, ChevronDown, ChevronUp, Check, X, MoreHorizontal, Bike, AlertCircle } from 'lucide-react';
        ...
        <TabsContent value="active">
          {activeBookings.length === 0 ? (
            ...
            <div className="space-y-4">
              {/* One booking limitation info banner */}
              {activeBookings.length > 0 && (
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-blue-700">
                        <span className="font-medium">Note:</span> You can only have one active booking at a time. 
                        To book another bike, you must first complete or cancel your current booking.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div className="flex items-center">
                        <div className="h-10 w-10 bg-gray-200 rounded-md overflow-hidden mr-2">
                          <img
                            src={bike.imageUrl || '/placeholder-bike.jpg'}
                            alt={bike.name}
                            className="h-full w-full object-cover"
